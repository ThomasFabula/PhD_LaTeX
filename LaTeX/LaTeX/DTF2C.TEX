...
Exakte analytische Lösungen physikalischer Problemstellungen
...
% Zusätzlich treten bei hohen
% Feldstärken nichtlineare Effekte (z.B.\ Elektrostriktion) auf, so daß der
% Zusammenhang zwischen der elektrischen Feldstärke und der
% mechanischen Reaktion des Systems nicht mehr linear ist. Außerdem ist
% das Großsignalverhalten durch Hystereseeffekte \cite{Smi92a} und
% Erhöhung der dielektrischen Verluste gekennzeichnet.
\end{itemize}
%
